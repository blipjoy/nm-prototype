	 ...
	 me.TMXTileset = me.Tileset.extend({
		...
		init: function (xmltileset) {
			...
			for ( var i = 0; i < tileInfo.length; i++) {
				...
				tileProp.isCollidable = tileProp.type ? true : false;
	...
	me.TiledLayer = Object.extend({
		...
		checkCollision : function(obj, pv) {
			...
			var res = {
				...
				xtile : undefined,
				xprop : {},
				xcorner: "", // corner that triggered the collision (top or bottom)
				y : 0, // !=0 if collision on y axis
				ytile : undefined,
				yprop : {},
				ycorner: "" // corner that triggered the collision (left or right)
			};
